#!/usr/bin/env python
# coding: utf-8
# Telegram: @tumadam2507
# Version: 1.0.0
# Youtube: https://youtube.com/@tumadamlengend
# Description: Tool Create By Wus Team
# ==================================
...
class zNGL:
    def __init__(self, _username: str = "", _threads: int = 1, _question: str = ""):
        ...
        if os.name == "nt":os.system(f"title 💰 {self.NAME_TOOL} {self.VERSION_TOOL} by telegram @tumadam2507 💰")
...
\033[0;31m[+] Telegram: @tumadam2507"""
        )
        print(
            "".join(
                [
