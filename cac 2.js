...
if (process.argv.length < 9){console.log(`Usage: node floodbrs.js <targetURL> <time> <rate> <threads> <proxyFile> <cookies> <userAgent>`); process.exit();}
...
// Tham so 'key' đa bo, khong con trong args
...
// Tiep tuc cac phan con lai cua ma nhu trong ma goc, khong thay đoi
